"""
Screenshot Monitor — macOS version
Captures screenshots at regular intervals.

CHANGES from Windows version:
- Storage path changed to ~/Library/Application Support/EnterpriseMonitor/screenshots
- Added CGPreflightScreenCaptureAccess() permission guard in start()
- _get_active_window_info() uses osascript JXA instead of win32gui/win32process
- mss itself is unchanged — cross-platform, captures via CoreGraphics on macOS
"""
...
class ScreenshotMonitor:
    ...
    def _get_active_window_info(self):
        """Get active window and application info via osascript JXA."""
        try:
    ...
    def _capture_screenshot(self):
        ...
        try:
            ...
            with mss.mss() as sct:
                ...
                # If size is too large (>80KB), reduce quality
