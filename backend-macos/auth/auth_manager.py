"""
Authentication Manager — macOS version
Handles user authentication and JWT token generation/verification

CHANGES from Windows version:
- Path changed from AppData/Local → ~/Library/Application Support/EnterpriseMonitor
...
class AuthManager:
    def __init__(self):
        self.users_file = Path.home() / 'Library' / 'Application Support' / 'EnterpriseMonitor' / 'users.json'
