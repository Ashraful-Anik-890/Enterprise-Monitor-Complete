...
PATH_DEVICE_STATUS:       str = "/api/pctracking/device-status"
PATH_CONFIRM_IDENTITY:    str = "/api/pctracking/confirm-identity"
PATH_DEVICE_LOGS:         str = "/api/pctracking/device-logs"
